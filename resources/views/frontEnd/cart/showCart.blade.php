        ...
        <div class="container">
                            ...
                            <td class="invert">
                                <div class="quantity">
                                    <form>
                                        ...
                                        <button type="submit" name="btn" class=" btn btn-lg btn btn-primary">
            ...
            <div class="checkout-left">
                <div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
                    <a href="{{ url('/') }}"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Back
                        To Shopping</a>
                    <?php
                    ...
                    ?>
                    <a href="{{ url('/checkout/payment') }}"><span class="glyphicon glyphicon-menu-left"
                                                                   aria-hidden="true"></span>Checkout</a>
                    <?php } else if ($customerId != null) { ?>
                    <a href="{{ url('/checkout/shipping') }}"><span class="glyphicon glyphicon-menu-left"
                                                                    aria-hidden="true"></span>Checkout</a>
                    <?php } else { ?>
                    <a href="{{ url('/checkout') }}"><span class="glyphicon glyphicon-menu-left"
                                                           aria-hidden="true"></span>Checkout</a>
                    <?php } ?>
                </div>
