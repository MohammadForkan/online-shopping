                ...
                <div class="men-wear-top">
                    ...
                    <div id="top" class="callbacks_container">
                        <ul class="rslides" id="slider3">
                            <li>
                                <img class="img-responsive" src="{{ asset('public/frontEnd/') }}/images/men1.jpg"
                                     alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{ asset('public/frontEnd/') }}/images/men2.jpg"
                                     alt=" "/>
                            </li>
                            <li>
                                <img class="img-responsive" src="{{ asset('public/frontEnd/') }}/images/men1.jpg"
            ...
            <div class="single-pro">
                ...
                @foreach($publishedCategoryProducts as $publishedCategoryProduct)
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{ asset($publishedCategoryProduct->productImage) }}" alt=""
