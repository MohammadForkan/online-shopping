        ...
        <div class="col-md-3 header-right footer-bottom">
            <ul>
                ...
                @if(Session::get('customerId'))
                    <li><a href="#" onclick="document.getElementById('customerLogoutForm').submit();" class="use1"
                           data-toggle="modal" data-target=""><span>Logout</span></a></li>
                    {{ Form::open(['url'=>'/customer/logout','method'=>'POST','id'=>'customerLogoutForm']) }}
                    {{ Form::close() }}
                @else
                    <li><a href="{{ url('/customer/new-login') }}" class="use1" data-toggle="modal"
                           data-target=""><span>Login</span></a></li>
                @endif
