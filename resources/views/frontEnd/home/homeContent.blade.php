                    ...
                    <div class="resp-tabs-container">
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                            @foreach($publishedProducts as $publishedProduct)
                                <div class="col-md-3 product-men" style="margin-top: 20px;">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item">
                                            <img src="{{ asset($publishedProduct->productImage) }}" alt=""
                                                 class="pro-image-front" height="250" width="250">
                                            <img src="{{ asset($publishedProduct->productImage) }}" alt=""
                                                 class="pro-image-back" height="250" width="250">
                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w1.png" alt=""
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w2.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w2.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw1.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw1.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw3.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw3.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/ep2.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/ep2.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/ep3.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/ep3.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g1.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g1.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g2.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g2.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g3.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/g3.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw2.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/mw2.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w4.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w4.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w3.png" alt=""
                                             class="pro-image-front">
                                        <img src="{{ asset('public/frontEnd/images/') }}/w3.png" alt=""
                                             class="pro-image-back">
                                        <div class="men-cart-pro">
